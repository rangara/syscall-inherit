...
asmlinkage long open1(char *file, int flags)
{
	printk(KERN_ALERT "Open1 system call\n");
	return 0;
}

asmlinkage long open_wrap(char *file, int flags)
{
	printk(KERN_ALERT "open1 system call wrapped");
	return 0;
}

asmlinkage long open_wrap_error(char *file, int flags)
{
	printk(KERN_ALERT "open1 system call wrapped returning error");
	return -EFAULT;
}
